...
public class ImageExporter {
  ...
  */
  ...
  public static List getSupportedExports() {
  ...
  */
  ...
  public static List getSupportedFileSuffixes() {
    List exps = getSupportedExports();
    ArrayList retval = new ArrayList(); 
  ...
  */
  ...
  public static List getFileSuffixesForType(String type) {
    ArrayList retval = new ArrayList();
    if (type.equals("TIFF")) {
      retval.add("tif");
      retval.add("tiff");      
